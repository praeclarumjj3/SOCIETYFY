...
public class Other_list extends Fragment implements OnMapReadyCallback, View.OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mUserLocations.size() == 0) { // make sure the list doesn't duplicate by navigating back
            if (getArguments() != null) {
                ...
                final ArrayList<UserLocation> locations = getArguments().getParcelableArrayList(getString(R.string.intent_ouser_locations));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_other_list, container, false);
        setHasOptionsMenu(true);
        mUserListRecyclerView = v.findViewById(R.id.other_list);
    ...
    private void initUI() {
        ...
        userlist = v.findViewById(R.id.other_list);
    ...
    private void getUsers() {
        ...
        userRepo.getOtherUsers(new EventListener<QuerySnapshot>() {
            @Override
