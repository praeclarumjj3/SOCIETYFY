...
public class Food_list extends Fragment implements OnMapReadyCallback, View.OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mUserLocations.size() == 0) { // make sure the list doesn't duplicate by navigating back
            if (getArguments() != null) {
                ...
                final ArrayList<UserLocation> locations = getArguments().getParcelableArrayList(getString(R.string.intent_fuser_locations));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mUserListRecyclerView = v.findViewById(R.id.food_list);
    ...
    private void initUI() {
        ...
        userlist = v.findViewById(R.id.food_list);
    ...
    private void getUsers() {
        ...
        userRepo.getFoodUsers(new EventListener<QuerySnapshot>() {
            @Override
